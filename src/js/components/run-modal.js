...
export function initRunModal() {
    ...
    <div class="modal-content run-modal" style="width: 560px; max-width: 95vw; background: var(--card-bg); border: 1px solid var(--accent-purple); border-radius: 12px; box-shadow: 0 25px 50px -12px rgba(147, 51, 234, 0.25);">
      ...
      <div class="detail-tabs" style="border-radius: 0; margin-bottom: 0; border-bottom: 1px solid rgba(255,255,255,0.05); padding: 0 1.5rem;">
        ...
        <div class="detail-tab" onclick="window.runModal.switchTab('scheduled')">Scheduled <span style="font-size: 0.6rem; background: rgba(124, 58, 237, 0.2); padding: 2px 4px; border-radius: 4px; margin-left: 4px; color: var(--accent-purple);">PRO</span></div>
      </div>
      ...
      <div class="modal-body" style="padding: 1.5rem; max-height: 70vh; overflow-y: auto;">
        ...
        <div id="rm-tab-quick" class="rm-tab-content active">
          ...
          <div id="rm-voice-notice" style="display: none; background: rgba(124, 58, 237, 0.1); border: 1px solid rgba(124, 58, 237, 0.3); padding: 1rem; border-radius: 8px; margin-bottom: 1.5rem; color: #c4b5fd;">
